...
$lgToolbarBody .= "<div id=\"g_tb\" style=\"display:none;position:absolute;z-index:1000;top:0;left:0;width:100%;height:28px;\"><div id=\"lg-toolbar\"></div></div>";
...
$lgToolbarBody .= "<script type=\"text/javascript\">
	...
	function receiveMessage(e) {
		if(e.origin === 'http://{$lgGlobalAppDomain}') {
			...
			if(!$('#lg-toolbar').isVisible()) $('#lg-toolbar').fadeIn(300);
		}
	}
</script>";

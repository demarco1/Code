...
class LigminchaGlobalObject {
	 ...
	 * - $supress is used to stop any revisions being generated by the change
	 */
	public function update( $origin = false, $supress = false ) {
		$db = JFactory::getDbo();
		$table = LigminchaGlobalDistributed::sqlTable();
		...
		if( !$supress && !$this->flag( LG_LOCAL ) ) LigminchaGlobalRevision::create( LG_UPDATE, $this->fields(), $origin, $private = false );
	}

...
define('_JSHOP_PAGSEGURO_TRANSACTION_END_DESCRIPTION', 'Seleccione o estado final que se establece no pedido, se o ordem do PagSeguro se realizou correctamente.');
define('_JSHOP_PAGSEGURO_TRANSACTION_PENDING_DESCRIPTION', 'Seleccione o estado final que se establece no pedido, se a transacção de pagamento não se completou.');
define('_JSHOP_PAGSEGURO_TRANSACTION_FAILED_DESCRIPTION', 'Seleccione o estado final que se estabelece no pedido para as transacções falhadas do PagSeguro.');
